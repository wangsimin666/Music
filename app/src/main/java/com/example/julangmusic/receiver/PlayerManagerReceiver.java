package com.example.julangmusic.receiver;
...
import com.example.julangmusic.util.UpdateUIThread;
...
public class PlayerManagerReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_UPDATE_UI_ADAPTER = "com.example.julangmusic.receiver.PlayerManagerReceiver:action_update_ui_adapter_broad_cast";
