...
import com.example.julangmusic.view.MusicPopMenuWindow;
import com.example.julangmusic.view.SideBar;
...
public class ModelActivity extends PlayBarBaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.model_music_toolbar);
    ...
    private void init() {
        ...
        playModeRl = findViewById(R.id.model_music_playmode_rl);
        playModeIv = findViewById(R.id.model_music_playmode_iv);
        playModeTv = findViewById(R.id.model_music_playmode_tv);
